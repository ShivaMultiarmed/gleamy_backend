...
class MediaRepositoryTests {
    ...
    void testMediaRepository()
    {
        ...
        Media expected = new Media("977e638e-0cb3-4f32-abec-f30351b8edaf", Media.Type.VIDEO,"gif",2L, expectedDateTime);
    ...
    void testAddMedia()
    {
        Media media = new Media(null,Media.Type.VIDEO, "gif", 3L, null);
    ...
    void testListOfMedia()
    {
        ...
        List<Media> real = mediaRepository.getMediaPortionByUserId(2L, Media.Type.IMAGE, 0L, 12);
